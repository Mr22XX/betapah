    ...
    <div class="flex justify-center items-center mt-52">
        <div class="bg-white/20 backdrop-blur-2xl lg:w-1/4 md:w-80 sm:w-96 h-96 rounded-lg text-white">
            <div class="p-8">
                ...
                <input type="text" name="password" class="rounded-sm border-0 bg-transparent border-b-2 border-indigo-600 focus:outline-none focus:ring-0  w-full">
                <label for="password2" class="block m-2">Konfirmasi Password</label>
                <input type="text" name="password2" class="rounded-sm border-0 bg-transparent border-b-2 border-indigo-600 focus:outline-none focus:ring-0  w-full">
                <div class="flex justify-end p-5">
                    <button type="submit" class="bg-indigo-600 h-10 w-16 rounded-md ">Daftar</button>
                </div>
            </div>
        </div>
    </div>
